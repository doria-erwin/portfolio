      ...
      <ul className='list-unstyled list-inline' id='social-icons'>
        <li className='list-inline-item bg-info'>
          <a
            ...
            className='text-dark w-100 h-100 d-flex flex-row justify-content-center align-items-center'
          >
      ...
      <ul className='list-unstyled list-inline mb-0'>
        <li className='list-inline-item'>
          <AnchorLink
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='text-lighter w-100 h-100 d-flex flex-row justify-content-center align-items-center'
          >
            <small>HOME</small>
          </AnchorLink>
        </li>
